...
declare module '@duffel/api/booking/Offers/Offers' {
    import { Client } from '@duffel/api/Client';
    import { Resource } from '@duffel/api/Resource';
    import { DuffelResponse, GetOfferPricedParams, ListOffersParams, Offer, OfferPriced, LoyaltyProgrammeAccounts, UpdateOffer } from '@duffel/api/types';
...
declare module '@duffel/api/Stays/Bookings/Bookings' {
    import { Client } from '@duffel/api/Client';
    import { ListParamsBookings, StaysBooking } from '@duffel/api/Stays/StaysTypes';
    import { Resource } from '@duffel/api/Resource';
    import { DuffelResponse, PaginationMeta } from '@duffel/api/types';
    ...
    export class Bookings extends Resource {
            ...
            /**
                ...
                */
            list: (options?: PaginationMeta & ListParamsBookings) => Promise<DuffelResponse<StaysBooking[]>>;
            /**
                * Retrieves a generator of all bookings. The results may be returned in any order.
                * @link https://duffel.com/docs/api/bookings/list-bookings
                */
            listWithGenerator: (options?: ListParamsBookings) => AsyncGenerator<DuffelResponse<StaysBooking>, void, unknown>;
            /**
                * Cancel a booking
                * @param {string} bookingId - The ID of the booking
                */
