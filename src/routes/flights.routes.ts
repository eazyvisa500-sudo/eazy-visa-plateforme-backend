...
import {
  ...
  bookFlight,
  bookGroupFlight,
  bookGroupFlightDirect,
  getOrder,
  cancelOrder,
  confirmOrderCancellation,
  searchFlightsAdvanced,
  searchAirportSuggestion,
...
router.post(
  ...
  requireAuth,
  requireManagerOrSuperAdmin,
  asyncHandler(searchFlightsAdvanced),
);
...
router.post(
  ...
  requireAuth,
  requireManagerOrSuperAdmin,
  asyncHandler(bookGroupFlightDirect),
);
...
router.post(
  ...
  requireAuth,
  requireManagerOrSuperAdmin,
  asyncHandler(confirmOrderCancellation),
);
