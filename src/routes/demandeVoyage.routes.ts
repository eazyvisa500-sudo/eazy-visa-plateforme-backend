...
router.get('/', requireAuth, requireManagerOrSuperAdmin, asyncHandler(getAllDemandesVoyage))
router.get('/:id', requireAuth, asyncHandler(getDemandeVoyageById))
router.put('/:id', requireAuth, asyncHandler(updateDemandeVoyage))
router.patch('/:id/approuver', requireAuth, requireManagerOrSuperAdmin, asyncHandler(approuverDemandeVoyage))
router.patch('/:id/rejeter', requireAuth, requireManagerOrSuperAdmin, asyncHandler(rejeterDemandeVoyage))
router.patch('/:id/annuler', requireAuth, asyncHandler(annulerDemandeVoyage))
router.patch('/:id/cloturer', requireAuth, requireManagerOrSuperAdmin, asyncHandler(cloturerDemandeVoyage))
